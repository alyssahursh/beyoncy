class Product < ActiveRecord::Base
  ...
  has_many :reviews
  # uploading images with Gem - we were unable to get files to save outside of local machine, so we abandoned this and went back to seeding in pictures from assets file as strings.
